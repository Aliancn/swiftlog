...
const file_proto_logstreamer_proto_rawDesc = "" +
	...
	"\vLogStreamer\x12N\n" +
	"\tStreamLog\x12\x1d.swiftlog.v1.StreamLogRequest\x1a\x1e.swiftlog.v1.StreamLogResponse(\x010\x01B/Z-github.com/aliancn/swiftlog/backend/gen/go/v1b\x06proto3"
